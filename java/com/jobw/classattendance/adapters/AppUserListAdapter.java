...
public class AppUserListAdapter extends RecyclerView.Adapter<DashboardViewHolder> {
    private Context context;
    private List<AppUserListInfo> arrayList;
    DashboardListAdapter.OnDashboardListItemClickListener dbListItemClickListener;
    private SparseBooleanArray mSelectedItemIds;

    public AppUserListAdapter(Context context, List<AppUserListInfo> arrayList,
                              DashboardListAdapter.OnDashboardListItemClickListener dbListItemClickListener) {
